...
def main():
    ...
    plt.tight_layout()
    plt.savefig('./output_module/point_operations.png')
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('./output_module/histograms.png')
    plt.show()
    # ------------------------------------------------
    ...
    print(f"OpenCV mean filter: {psnr_mean_cv:.2f} dB")
    print(f"OpenCV Gaussian filter: {psnr_gauss_cv:.2f} dB")
    ...
    plt.subplot(2,4,2), plt.imshow(mean_cv, cmap='gray'), plt.title('Mean Filter (OpenCV)')
    plt.subplot(2,4,3), plt.imshow(gauss_cv, cmap='gray'), plt.title('Gaussian Filter (OpenCV)')
    plt.tight_layout()
    plt.savefig('./output_module/denoising.png')
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('./output_module/edge_detection.png')
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('./output_module/pyramid_fusion.png')
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('./output_module/extensions.png')
    plt.show()

    print("\nExperiment completed! All results saved in './output_module' folder.")
