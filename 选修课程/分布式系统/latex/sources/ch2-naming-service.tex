...
\newcommand{\figimg}[2][]{%
  \includegraphics[width=\linewidth,height=.78\textheight,keepaspectratio,#1]{#2}%
}

\title{第 2 章\quad 命名服务}
\author{根据图片型 PDF 视觉完整转写}
\date{}
...
\begin{figure}[H]
  \centering
  \figimg{figures/fig01-home-based.png}
...
\begin{figure}[H]
  \centering
  \figimg{figures/fig02-chord-panel.png}
...
\begin{figure}[H]
  \centering
  \figimg{figures/fig04-location-domain-tree.png}
...
\begin{figure}[H]
  \centering
  \figimg{figures/fig05-location-lookup.png}
...
\begin{figure}[H]
  \centering
  \figimg{figures/fig06-naming-graph.png}
...
\begin{figure}[H]
  \centering
  \figimg{figures/fig07-mount-foreign-space.png}
...
\begin{figure}[H]
  \centering
  \figimg{figures/fig08-mount-nested-dirs.png}
...
\begin{figure}[H]
  \centering
  \figimg{figures/fig09-transitive-mounting.png}
...
\begin{figure}[H]
  \centering
  \figimg{figures/fig10-iterative-resolution.png}
...
\begin{figure}[H]
  \centering
  \figimg{figures/fig11-recursive-resolution.png}
...
\begin{figure}[H]
  \centering
  \figimg[width=.86\linewidth]{figures/fig12-modern-dns.png}
  \caption{现代 DNS 架构：多个客户端可以经本地 resolver 访问互联网中的多个 name server。}
\end{figure}

\begin{figure}[H]
  \centering
  \figimg[width=.86\linewidth]{figures/fig13-traditional-dns.png}
