...
\title{第 1 章\quad 分布式系统概况}
\author{根据图片型 PDF 视觉转写}
\date{}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.68\textwidth]{figures/communication-middleware.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.78\textwidth]{figures/distributed-system-layer.png}
\caption{分布透明性的内涵}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.88\textwidth]{figures/virtualization-types.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figures/client-server-form.png}
